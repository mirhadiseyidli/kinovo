...
//         setFullSummary((prev) => prev + event.data);
//       };
...
//       >
//         <LinearGradient
//           colors={['rgba(66, 65, 77, 0.9)', 'rgba(46, 45, 57, 0.9)']}
//           start={{ x: 0, y: 0 }}
//           end={{ x: 1, y: 1 }}
//           style={{
//             position: 'absolute',
...
//                 /> )
//               }
//               <Text style={{ fontSize: 16, color: themeColors.text, fontWeight: 'bold', marginBottom: 8 }}>
//                 {highlightedSentence}
//               </Text>
//             </View>
