...
// import { aiSummaryCache } from '@/utils/homeScreenCache';
...
//       // Check cache first
//       const cachedSummary = aiSummaryCache.get(userId);
//       if (cachedSummary) {
//         console.log('📦 [Cache Hit] AI summary loaded from cache');
...
//       console.log('🌐 [WebSocket] Connecting for AI summary');
...
//           if (accumulatedSummary && userId) {
//             aiSummaryCache.set(userId, accumulatedSummary);
//             console.log('💾 [Cache Set] AI summary cached');
//           }
//           return;
//         }
