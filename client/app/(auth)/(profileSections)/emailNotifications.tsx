...
import { View, ScrollView, TouchableOpacity, Switch, RefreshControl, ActivityIndicator } from 'react-native';
...
const EmailNotifications = () => {
  ...
  const { preferences, loading, refreshing, togglePreference, onRefresh } = useNotificationPreferences('email');
    ...
    <ThemedView style={{ flex: 1 }}>
      ...
      >
        <ThemedText style={{ 
          ...
          Choose which notifications you want to receive via email. We recommend keeping only important notifications enabled to avoid inbox clutter.
        </ThemedText>
